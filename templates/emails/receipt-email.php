 ...
 * @var bool $plain_text
 * @var \IHumbak\Invoices\Modules\Email\ReceiptEmail $email
 */
...
<p>
	...
	printf(
		...
		esc_html__( 'Please find attached your receipt %s.', 'ihumbak-invoices' ),
	...
	<?php if ( $order ) : ?>
		<p>
			...
			printf(
				...
				esc_html__( 'This receipt is for order %s.', 'ihumbak-invoices' ),
...
<h2><?php esc_html_e( 'Receipt Details', 'ihumbak-invoices' ); ?></h2>
	...
	<tbody>
		<tr>
			<th scope="row" style="text-align: left; border: 1px solid #e5e5e5; padding: 12px;">
				<?php esc_html_e( 'Receipt Number', 'ihumbak-invoices' ); ?>
			</th>
		...
		<tr>
			<th scope="row" style="text-align: left; border: 1px solid #e5e5e5; padding: 12px;">
				<?php esc_html_e( 'Total Amount', 'ihumbak-invoices' ); ?>
			</th>
			<td style="text-align: left; border: 1px solid #e5e5e5; padding: 12px;">
				<strong><?php echo esc_html( number_format( $document->getTotal(), 2, '.', ' ' ) . ' ' . $document->getCurrency() ); ?></strong>
			</td>
		</tr>
		<?php if ( $document->getPaymentMethodDisplayName() ) : ?>
		<tr>
			<th scope="row" style="text-align: left; border: 1px solid #e5e5e5; padding: 12px;">
				<?php esc_html_e( 'Payment Method', 'ihumbak-invoices' ); ?>
			</th>
			<td style="text-align: left; border: 1px solid #e5e5e5; padding: 12px;">
				<?php echo esc_html( $document->getPaymentMethodDisplayName() ); ?>
			</td>
		</tr>
		<?php endif; ?>
	</tbody>
...
<p>
	<?php esc_html_e( 'The receipt PDF is attached to this email.', 'ihumbak-invoices' ); ?>
</p>
