<?php
/**
 * Receipt email template (Plain text).
 *
...
echo "----------------------------------------\n";
echo esc_html__( 'Receipt Details', 'ihumbak-invoices' );
echo "\n----------------------------------------\n\n";

echo esc_html__( 'Receipt Number', 'ihumbak-invoices' ) . ': ' . esc_html( $document->getDocumentNumber() ) . "\n";
...
echo "\n";
echo esc_html__( 'The receipt PDF is attached to this email.', 'ihumbak-invoices' );
echo "\n\n";
