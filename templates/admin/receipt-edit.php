...
$page_title = $is_new
    ? __( 'New Receipt', 'ihumbak-invoices' )
    : sprintf(
        /* translators: %s: Document number */
        __( 'Edit Receipt: %s', 'ihumbak-invoices' ),
...
<div class="wrap ihumbak-document-edit-wrap">
    ...
    <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" id="ihumbak-document-form">
        <input type="hidden" name="action" value="ihumbak_save_receipt">
        ...
        <div class="ihumbak-document-columns">
            ...
            <div class="ihumbak-document-main">
                ...
                <div class="ihumbak-card">
                    <h3><?php esc_html_e( 'Receipt Details', 'ihumbak-invoices' ); ?></h3>

                    <table class="form-table">
                        <tr>
                            <th><label for="document_number"><?php esc_html_e( 'Receipt Number', 'ihumbak-invoices' ); ?></label></th>
                            <td>
                                <?php if ( $is_new ) : ?>
