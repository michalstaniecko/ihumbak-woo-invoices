    ...
    <div class="ihumbak-form-fields">
        <div class="ihumbak-form-field">
            ...
            <input type="text" id="buyer_name" name="buyer[name]"
                   value="<?php echo esc_attr( $buyer['name'] ?? '' ); ?>" required <?php readonly( ! $can_edit ); ?>>
        </div>
        <?php if ( $require_nip ) : ?>
        <div class="ihumbak-form-field">
            ...
            <input type="text" id="buyer_nip" name="buyer[nip]"
                   value="<?php echo esc_attr( $buyer['nip'] ?? '' ); ?>" required <?php readonly( ! $can_edit ); ?>>
        </div>
        <?php else : ?>
        <div class="ihumbak-form-field">
            <label for="buyer_nip"><?php esc_html_e( 'NIP', 'ihumbak-invoices' ); ?></label>
            <input type="text" id="buyer_nip" name="buyer[nip]"
                   value="<?php echo esc_attr( $buyer['nip'] ?? '' ); ?>" <?php readonly( ! $can_edit ); ?>>
        ...
        <div class="ihumbak-form-field">
            ...
            <textarea id="buyer_address" name="buyer[address]" rows="2" <?php readonly( ! $can_edit ); ?>><?php echo esc_textarea( $buyer['address'] ?? '' ); ?></textarea>
        </div>
        <div class="ihumbak-form-field">
